...
from local_trainer_adult import local_train_adult_moon
from models_adult import get_adult_model

def run_moon_adult(config, client_train_loaders, client_val_loaders,
    ...
    for rnd in range(1, config["total_rounds"] + 1):
        ...
        for i in range(N):
            ...
            lm = local_train_adult_moon(lm, global_model, prev_models[i],
