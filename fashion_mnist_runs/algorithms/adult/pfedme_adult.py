...
from local_trainer_adult import local_train_adult_pfedme
from models_adult import get_adult_model

def run_pfedme_adult(config, client_train_loaders, client_val_loaders,
                     global_test_loader, device, feature_dim):
    print("\n" + "="*50 + "\n  Running: pFedME [Adult]\n" + "="*50)
    ...
    for rnd in range(1, config["total_rounds"] + 1):
        ...
        for i in range(N):
            ...
            w_i, personal_models[i] = local_train_adult_pfedme(
