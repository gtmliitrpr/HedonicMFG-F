...
from local_trainer_fmnist import local_train_fmnist_moon
from models_fmnist import get_fmnist_model

def run_moon_fmnist(config, client_train_loaders, client_val_loaders,
                    global_test_loader, device):
    print("\n" + "="*50 + "\n  Running: MOON [FashionMNIST]\n" + "="*50)
    ...
    for rnd in range(1, config["total_rounds"] + 1):
        ...
        for i in range(N):
            ...
            lm = local_train_fmnist_moon(lm, global_model, prev_models[i],
