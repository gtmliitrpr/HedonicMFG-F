"""Random Clustering — FashionMNIST"""
...
def run_random_clustering_fmnist(config, client_train_loaders, client_val_loaders,
                                  global_test_loader, device):
    print("\n" + "="*50 + "\n  Running: RandomCluster [FashionMNIST]\n" + "="*50)
    ...
    for rnd in range(warmup + 1, total_rounds + 1):
        ...
        if rnd % 10 == 0 or rnd == warmup + 1:
            print_round_summary("RandomCluster", rnd, total_rounds, g_acc, sum(c_accs)/N)
