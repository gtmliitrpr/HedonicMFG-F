"""FedProx — FashionMNIST"""
import copy, time
from utils import ResultsTracker, print_round_summary, evaluate_model, fedavg_aggregate
from local_trainer_fmnist import local_train_fmnist_fedprox
from models_fmnist import get_fmnist_model

def run_fedprox_fmnist(config, client_train_loaders, client_val_loaders,
                       global_test_loader, device):
    print("\n" + "="*50 + "\n  Running: FedProx [FashionMNIST]\n" + "="*50)
