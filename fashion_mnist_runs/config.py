...
# ─────────────────────────────────────────────
# FASHIONMNIST CONFIG
# Tuned for HedonicMFG advantage:
#   - Simple CNN (no BN) → stable gradients for coalition formation
#   - K=3 coalitions: fashion items cluster naturally
#   - T_w=12: CNN gradients stabilise faster than complex nets
#   - High γ_grad=0.9: fashion CNN gradients very informative
#   - λ_fair=0.5: moderate fairness — FashionMNIST has clear hard classes
#   - Personalized head: client-specific fashion preferences
# ─────────────────────────────────────────────
FMNIST_CONFIG = {
    # Data
    "dataset": "fmnist",
    ...
    # MFG utility weights — tuned for FashionMNIST
    "lambda_perf": 1.0,
    "beta_size": 0.04,
    "gamma_grad": 0.90,
    "mu_fair": 0.4,
